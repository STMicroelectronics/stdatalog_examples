...
sensors, setting time ranges, specifying output folder, and more.
...
def hsd_toWav(
    ...
    """Convert acquisition data to WAV files, optionally split by tags.
    ...
    sensor_name : str
        Sensor name to export, or 'all' for all active sensors, or empty to
        prompt selection.
    start_time : int
    ...
    split_per_tags : bool
        If True, split output WAV files per tag region.
